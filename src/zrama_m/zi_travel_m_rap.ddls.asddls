...
@EndUserText.label: 'Travel Agency: Travel RAP'
//@Metadata.ignorePropagatedAnnotations: true
define root view entity ZI_TRAVEL_M_RAP
  as select from zrap_travel_m
  composition [0..*] of ZI_BOOK_M_RAP            as _Booking
